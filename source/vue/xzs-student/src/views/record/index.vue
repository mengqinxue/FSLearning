     ...
     <el-row :gutter="50">
       <el-col :span="18">
         <el-table v-loading="listLoading" :data="tableData" fit highlight-current-row style="width: 100%" @row-click="itemSelect">
           <el-table-column prop="id" label="No." width="90px"/>
           <el-table-column prop="paperName" label="Name"  />
           <el-table-column prop="subjectName" label="Subject"  width="75" />
           ...
           <el-table-column prop="createTime" label="Time to Practice"  width="170" />
           <el-table-column  align="right" width="70">
             <template slot-scope="{row}">
               ...
               <router-link target="_blank" :to="{path:'/read',query:{id:row.id}}" v-if="row.status === 2 ">
                 <el-button  type="text" size="small">Review</el-button>
               </router-link>
             </template>
           </el-table-column>
         </el-table>
       ...
       <el-col  :span="6" >
         <el-card  class="record-answer-info">
            <el-form label-width="50%" >
              <!-- <el-form-item label="System Score：">
